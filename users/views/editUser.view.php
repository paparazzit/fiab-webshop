        ...
        <div class="row">
            <div class="col-md-9 " >
              ...
              <ul class="list-group list-group-flush bg-dark" >
               <li class="list-group-item"> <?php echo $singleUser->name?> <a  href="#" class="btn btn-warning btn-sm float-end" data-bs-toggle="modal" data-bs-target="#changeName">
                Change
                </a></li>
               <li class="list-group-item"> <?php echo $singleUser->email?> <a href="#" class="btn btn-sm btn-warning float-end" data-bs-toggle="modal" data-bs-target="#changeEmail" >Change</a></li>
               ...
               <?php else:?>
                <p class="btn btn-sm btn-warning float-end m-0"><?php echo $singleUser->role?></p>
               ...
               <li class="list-group-item"> Created <a href="#" class="btn  btn-primary float-end"><?php echo $singleUser->created_at?></a></li>
               <?php if($singleUser->updated_at !== NULL):?>
                <li class="list-group-item"> Edited <a href="#" class="btn  btn-primary float-end"><?php echo $singleUser->updated_at?></a></li>
                <?php endif;?>
              </ul>
      ...
      <div class="modal-body">
        <form action="users/changeUserName.php" method="POST" class='form' id="changeEmailForm">
            ...
            <div class="form-group">
                ...
                <input type="text" name='name' id="name" class="form-control" value="<?php echo $singleUser->name?>" required >
            </div>
      ...
      <div class="modal-body">
        <form action="users/changeUserEmail.php" method="POST" class='form' id="changeNameForm">
            ...
            <div class="form-group">
                ...
                <input type="email" name='email' id="email" class="form-control" value="<?php echo $singleUser->email?>" required >
            </div>
            <button type="submit" class="btn btn-primary mt-3 float-end">Change name</button>
        </form>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="users/updatePassword.php" method="POST" class='form' id="changePasswordForm">
           <div class="form-group">
           <input type="hidden" name="userId" id="userId" value="<?php echo $singleUser->id?>">
